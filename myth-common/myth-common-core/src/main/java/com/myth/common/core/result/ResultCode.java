package com.myth.common.core.result;
...
public enum ResultCode implements  IResultCode, Serializable {
    ...
    USERNAME_VERIFICATION_ERROR("A0110","用户名校验失败"),
    USERNAME_EXIST_ERROR("A0111","用户名已存在"),
    PASSOWORD_VERIFICATION_ERROR("A0120","密码校验失败"),
    VERIFICATION_CODE_ERROR("A0130","校验码输入错误"),
    SHORT_MESSAG_EVERIFICATION_CODE_ERROR("A0131","短信校验码输入错误"),
    EMAIL_EVERIFICATION_CODE_ERROR("A0132","邮件校验码输入错误"),
    MOBILE_VERIFICATION_ERROR("A0151","手机格式校验失败"),
    ADDRESS_VERIFICATION_ERROR("A0152","地址格式校验失败"),
    EMAIL_PARSE_ERROR("A0153 ","邮箱格式校验失败"),


    USER_LOGIN_ERROR("A0200","用户登录异常"),
    ACCOUNT_NOT_FOUND_ERROR("A0201","用户账户不存在"),
    ...
    AUTH_UNAUTHORIZED ("A0301","访问未授权"),
    AUTH_FORBIDDEN ("A0312","权限不足"),
    ...
    SEND_SHORT_MESSAGE_ERROR("C0001","短信发送异常"),
    BUSINESS_LIMIT_CONTROL("C0002","发送短信过于频繁");
